    ...
    return (
        <div className="bg-dark-100 min-h-screen pb-16">
            <div className="container mx-auto px-4 py-16 max-w-4xl">
                <h1 className="text-4xl md:text-5xl font-bold mb-8 text-white">Our Initiatives</h1>
                <p className="text-lg text-white/80 mb-12">
                    Explore our core programs and projects designed to advance AI literacy, technical skills, and community at AISC.
                </p>
                    ...
                    >
                        <div className="md:flex">
                            ...
                            <div className="md:w-2/3 p-8 flex flex-col justify-center">
                                <h2 className="text-2xl md:text-3xl font-bold mb-2 text-white" id={initiative.id}>
                                    {initiative.title}
                                </h2>
                                <p className="text-white/80 mb-4">{initiative.description}</p>
                                <ul className="list-disc pl-5 space-y-2 mb-4">
                                    {initiative.details.map((detail, idx) => (
                                        <li key={idx} className="text-white/70">{detail}</li>
                                    ))}
                                </ul>
                                <Link
                                    href={`#${initiative.id}`}
                                ...
                                >
                                    Learn more
                                    <svg className="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" /></svg>
                                </Link>
                            </div>
                        </div>
                    </section>
