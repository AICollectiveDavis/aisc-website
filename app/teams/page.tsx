    ...
    const TeamSection = ({
        ...
        <section className="py-8">
            <div className="container mx-auto px-4">
                <h2 id={id} className="text-3xl font-bold mb-8 text-center">
                    {title}
                </h2>
            ...
            <section className="py-8 bg-gradient-to-br from-background via-card to-background relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center max-w-3xl mx-auto">
                        <h1 className="mt-16 text-4xl md:text-5xl font-bold mb-6 gradient-text">
                            Our Team
                        </h1>
                        <p className="text-muted-foreground text-lg">
                            Meet the dedicated students who make AISC @ Davis
                            possible.
                        </p>
                    </div>
                </div>
            ...
            <section className="py-16 bg-gradient-to-br from-primary/10 via-background to-accent/10">
                <div className="container mx-auto px-4 text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-muted-foreground">
                        We&#39;re always looking for passionate students to help
                        lead AISC initiatives and events. Leadership positions
                        open at the end of each academic year. Keep an eye out
                        for applications!
                    </p>
