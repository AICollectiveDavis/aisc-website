      ...
      <main className="relative">
        ...
        <section className="py-16 relative z-30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-12 text-center text-balance">Our Initiatives</h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Innovation */}
              <Collapsible open={openSections.innovation} onOpenChange={() => toggleSection("innovation")}>
                <Card className="glass-card border-border/50">
                  <CollapsibleTrigger className="w-full">
                    <div className="flex items-center justify-between p-5 hover:bg-white/5 transition-colors rounded-lg">
                      <div className="flex items-center gap-3">
                        <span className="text-xl font-semibold text-primary">Innovation</span>
                      </div>
                      <ChevronDown
                        className={`h-4 w-4 text-muted-foreground transition-transform ${
                          openSections.innovation ? "rotate-180" : ""
                        }`}
                      />
                    </div>
                  </CollapsibleTrigger>
                  ...
                  <CollapsibleContent>
                    <CardContent className="p-5 pt-0 space-y-3">
                      <Card className="border-border/50 hover:border-border/75 transition-colors">
                        <CardContent className="p-4">
                          <h3 className="text-base font-semibold mb-1">Software Engineering</h3>
                          <p className="text-muted-foreground text-sm text-pretty">
                            Applied development projects focusing on building real-world AI applications and systems.
                          </p>
                        </CardContent>
                      </Card>
                      <Card className="border-border/50 hover:border-border/75 transition-colors">
                        <CardContent className="p-4">
                          <h3 className="text-base font-semibold mb-1">Research & Development</h3>
                          <p className="text-muted-foreground text-sm text-pretty">
                            Opportunities to engage in cutting-edge AI research with faculty and industry partners.
                          </p>
                        </CardContent>
                      </Card>
                    </CardContent>
              ...
              <Collapsible open={openSections.development} onOpenChange={() => toggleSection("development")}>
                <Card className="glass-card border-border/50">
                  <CollapsibleTrigger className="w-full">
                    <div className="flex items-center justify-between p-5 hover:bg-white/5 transition-colors rounded-lg">
                      <div className="flex items-center gap-3">
                        <span className="text-xl font-semibold text-secondary">Member Development</span>
                      </div>
                      <ChevronDown
                        className={`h-4 w-4 text-muted-foreground transition-transform ${
                          openSections.development ? "rotate-180" : ""
                        }`}
                      />
                    </div>
                  </CollapsibleTrigger>
                  ...
                  <CollapsibleContent>
                    <CardContent className="p-5 pt-0 space-y-3">
                      <Card className="border-border/50 hover:border-border/75 transition-colors">
                        <CardContent className="p-4">
                          <h3 className="text-base font-semibold mb-1">Beginner Projects</h3>
                          <p className="text-muted-foreground text-sm text-pretty">
                            Accessible project opportunities for newcomers to gain hands-on experience with AI.
                          </p>
                        </CardContent>
                      </Card>
                      <Card className="border-border/50 hover:border-border/75 transition-colors">
                        <CardContent className="p-4">
                          <h3 className="text-base font-semibold mb-1">Education & Workshops</h3>
                          <p className="text-muted-foreground text-sm text-pretty">
                            Foundational learning and practical sessions on AI topics, tools, and techniques.
                          </p>
                        </CardContent>
                      </Card>
                      <Card className="border-border/50 hover:border-border/75 transition-colors">
                        <CardContent className="p-4">
                          <h3 className="text-base font-semibold mb-1">User Experience Research</h3>
                          <p className="text-muted-foreground text-sm text-pretty">
                            Feedback-driven research to improve member satisfaction, retention, and engagement.
                          </p>
                        </CardContent>
                      </Card>
                    </CardContent>
              ...
              <Collapsible open={openSections.operations} onOpenChange={() => toggleSection("operations")}>
                <Card className="glass-card border-border/50">
                  <CollapsibleTrigger className="w-full">
                    <div className="flex items-center justify-between p-5 hover:bg-white/5 transition-colors rounded-lg">
                      <div className="flex items-center gap-3">
                        <span className="text-xl font-semibold text-primary">Operations</span>
                      </div>
                      <ChevronDown
                        className={`h-4 w-4 text-muted-foreground transition-transform ${
                  ...
                  <CollapsibleContent>
                    <CardContent className="p-5 pt-0 space-y-3">
                      <Card className="border-border/50 hover:border-border/75 transition-colors">
                        <CardContent className="p-4">
                          <h3 className="text-base font-semibold mb-1">Creative</h3>
                          <p className="text-muted-foreground text-sm text-pretty">
                      ...
                      <Card className="border-border/50 hover:border-border/75 transition-colors">
                        <CardContent className="p-4">
                          <h3 className="text-base font-semibold mb-1">Content Strategy</h3>
                          <p className="text-muted-foreground text-sm text-pretty">
                      ...
                      <Card className="border-border/50 hover:border-border/75 transition-colors">
                        <CardContent className="p-4">
                          <h3 className="text-base font-semibold mb-1">External Affairs</h3>
                          <p className="text-muted-foreground text-sm text-pretty">
                            Outreach and partnerships with faculty, industry, and student organizations.
                          </p>
                        </CardContent>
                      </Card>
                    </CardContent>
              ...
              <Card className="glass-card">
                <CardContent className="p-6">
                  <p className="text-muted-foreground mb-4 text-pretty">
                    ...
                    workshops and mentorship helped me land an internship at a leading AI company. I now work at
                    Microsoft as a SWE Intern."
                  </p>
