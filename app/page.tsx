                        ...
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 md:gap-12">
                            ...
                            <div className="ml-12 md:w-1/2 md:pr-12 relative z-50">
                                ...
                                <p className="text-muted-foreground mb-8 max-w-lg text-pretty">
                                    A global network of student organizations
                                    dedicated to making AI literacy accessible
                                    for everyone. Through pre-professional
                                    programs, hands-on events, and industry
                                    connections, we’re building a more informed,
                                    diverse, and equitable future in AI.
                                </p>
                            ...
                            <div className="blur md:w-1/2 h-[400px] md:h-[500px] relative z-40">
                                <div className="absolute inset-0 overflow-hidden">
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                'linear-gradient(135deg, rgba(14, 165, 233, 0.6), rgba(14, 165, 233, 0.2))',
                                            borderRadius:
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                'linear-gradient(135deg, rgba(249, 168, 212, 0.5), rgba(249, 168, 212, 0.15))',
                                            borderRadius:
                                                '50% 60% 40% 50% / 60% 40% 60% 40%',
                                            filter: 'blur(40px)',
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                'linear-gradient(135deg, rgba(14, 165, 233, 0.4), rgba(14, 165, 233, 0.08))',
                                            borderRadius:
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                'linear-gradient(135deg, rgba(249, 168, 212, 0.45), rgba(249, 168, 212, 0.08))',
                                            borderRadius:
                                                '50% 30% 60% 40% / 30% 60% 40% 70%',
                                            filter: 'blur(30px)',
                                            animationDuration: '22s',
                                            transform: 'rotate(15deg)',
                                            boxShadow:
                                                '0 0 50px rgba(249, 168, 212, 0.2)',
                                        }}
                                    />
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                'radial-gradient(circle, rgba(249, 168, 212, 0.5) 0%, rgba(249, 168, 212, 0) 70%)',
                                            borderRadius: '50%',
                                            filter: 'blur(15px)',
                                        }}
                                    />
