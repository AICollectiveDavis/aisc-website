                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
                    ...
                    <div className="mb-12">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl">
                            Join us for workshops, panels, showcases, and social
                            events. Connect with the AI community, learn new
                                    ...
                                    <div className="grid md:grid-cols-5 gap-0">
                                        ...
                                        <div className="md:col-span-3 p-4 md:p-6 flex flex-col justify-between">
                                            ...
                                            <div className="flex gap-4">
                                                <Button
                                                    asChild
                                                    className="gradient-btn flex-1 md:flex-initial"
                                                >
                                                    <a
                                                        href={event.lumaLink}
                                                        target="_blank"
                                ...
                                >
                                    <div className="text-left">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            ...
                                            socials, and community gatherings
                                        </p>
                                    </div>
                                    {showPastEvents ? (
                        ...
                        <Card className="glass-card">
                            <CardContent className="p-6 md:p-8">
                                ...
                                <p className="text-sm text-muted-foreground mb-4 max-w-2xl mx-auto">
                                    Stay updated on all our events by following
                                    us on social media and joining our
                                    community. New events are added regularly!
                                </p>
