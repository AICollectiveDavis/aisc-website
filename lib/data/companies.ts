...
export const companies: Company[] = [
    ...
    { name: 'Comcast', logo: '/logos/comcast.svg' },
    { name: 'Activision Blizzard', logo: '/logos/Activision_Blizzard_logo.svg' },
    { name: 'Brex', logo: '/logos/brex.png' },
    ...
    { name: 'Archer', logo: '/logos/archer.png' },
